...
2. **value**: Ionization energy (eV): DFT calculated
3. **hp_id**: A unique pol_id assigned to each homopolymer within the database (PolyDB).
4. **smiles1**: Polymer SMILES
5. **canonical_smiles**: canonical polymer SMILES
