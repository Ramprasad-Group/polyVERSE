...
[Novel high voltage polymer insulators using computational and data-driven techniques](https://doi.org/10.1063/5.0044306), J. Chem. Phys. 154, 174906 (2021).

The dataset comprises three primary columns:

1. **SN**: Serial Number
2. **smiles**: SMILES Representation of Polymers
3. **bandgap_chain**: Bandgap of Polymer Chains
